(function(a) {
    ...
    var g = function(k, j) {
        ...
        this.pickerPosition = j.pickerPosition || this.element.data("picker-position") || "bottom-left";
    ...
    g.prototype = {
        ...
        place: function() {
            ...
            if (this.pickerPosition === "top-left" || this.pickerPosition === "top-right") {
                ...
                m = n.top + this.height +108;
            }
            m = m - k.top;
            l = l - k.left;
            w = $('.form_datetime input').css('width');
            this.picker.css({
                top: m + 7,
                left: l+9,
                width: w,
            ...
            $('.table-condensed').css('width',(parseInt(w)-9));
        },
...
// 			$('.datetimepicker-dropdown-bottom-right').eq(i).css('display','block');
// 		})
// 			//$('.datetimepicker-dropdown-bottom-right').eq(i).css('display','block');
// 		});
// });